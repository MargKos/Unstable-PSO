...
axs[0].plot(np.linspace(1, T_PSO_short, int(T_PSO_short/delta)), MeanClassic[0:T_PSO_short],'s',markersize=9,markevery=50,color='orange',label='Classic')
...
axs[0].plot(np.linspace(1, T_PSO_short, int(T_PSO_short/delta)), MeanOrbit[0:T_PSO_short],'o',markersize=7,markevery=50, color='blue',  label='Divergent Oscillator')
...
axs[1].plot(np.linspace(1, T_PSO_short_c, T_PSO_short_c), ConcentrationClassic[0:T_PSO_short_c],linewidth=2.0,color='orange',label='Classic')
...
axs[1].plot(np.linspace(1, T_PSO_short_c, T_PSO_short_c),ConcentrationOrbit[0:T_PSO_short_c],linewidth=2.0,color='blue',  label='Divergent Oscillator')
axs[1].plot(np.linspace(1, T_PSO_short_c, T_PSO_short_c), ConcentrationClassic[0:T_PSO_short_c],'s',markersize=9,markevery=50,color='orange',label='Classic')
...
axs[1].plot(np.linspace(1, T_PSO_short_c, T_PSO_short_c),ConcentrationOrbit[0:T_PSO_short_c],'s',markersize=7,markevery=50,color='blue',  label='Divergent Oscillator')
...
axs[0].plot(np.linspace(1, T_PSO_s, T_PSO_s), AverageNumberOfFoundLocalMinimaC[0:T_PSO_s],'s',markersize=7,markevery=100, color='orange', label='Classic')
...
axs[0].plot(np.linspace(1, T_PSO_s, T_PSO_s),AverageNumberOfFoundLocalMinimaO[0:T_PSO_s],'o', markersize=7,markevery=100, color='blue', label='Divergent Oscillator')
axs[0].tick_params(axis='x', labelsize=30)
axs[0].tick_params(axis='y', labelsize=30)
axs[0].set_xlabel('time',  fontsize=30)
...
axs[1].hist(AllLocalMinimaCValue,histtype='step', bins=50,color='orange',label='Classic')
axs[1].hist(AllLocalMinimaHValue,histtype='step', bins=50,color='green',label='Damped')
axs[1].hist(AllLocalMinimaOValue,histtype='step', bins=50,color='blue',  label='Divergent Oscillator')

# 
a=plt.hist(AllLocalMinimaCValue,histtype='step', bins=50,color='orange',label='Classic')
F_C=int(a[0][0])

a=plt.hist(AllLocalMinimaHValue,histtype='step', bins=50,color='green',label='Damped')
F_H=int(a[0][0])

a=plt.hist(AllLocalMinimaOValue,histtype='step', bins=50,color='blue',  label='Divergent Oscillator')
F_O=int(a[0][0])
