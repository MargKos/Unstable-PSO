...
axs[0,0].text(0.1, -0.2, '(a)', transform=axs[0,0].transAxes, fontsize=20, va='top', ha='right')
axs[0,1].text(0.1, -0.2, '(b)', transform=axs[0,1].transAxes, fontsize=20, va='top', ha='right')
axs[1,0].text(0.1, -0.3, '(c)', transform=axs[1,0].transAxes, fontsize=20, va='top', ha='right')
axs[1,1].text(0.1, -0.3, '(d)', transform=axs[1,1].transAxes, fontsize=20, va='top', ha='right')
axs[2,0].text(0.1, -0.4, '(e)', transform=axs[2,0].transAxes, fontsize=20, va='top', ha='right')
axs[2,1].text(0.1, -0.4, '(f)', transform=axs[2,1].transAxes, fontsize=20, va='top', ha='right')
...
axs[2].legend(bbox_to_anchor=(-2, 1.02, 1, 0.35), loc="upper left",
