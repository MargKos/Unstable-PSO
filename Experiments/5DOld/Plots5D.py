...
axs[1].plot(np.linspace(1, T_PSO_s2, T_PSO_s2), ConcentrationDamped[0:T_PSO_s2],'s',markersize=9,markevery=46,color='green')
axs[1].plot(np.linspace(1, T_PSO_s2, T_PSO_s2),ConcentrationDivergent[0:T_PSO_s2],'s',markersize=9,markevery=46,color='blue')
...
axs[1].plot(np.linspace(20,200,200),Random, color='black')
axs[1].plot(np.linspace(20,200,200),Random,'o', markevery=10,color='black')
