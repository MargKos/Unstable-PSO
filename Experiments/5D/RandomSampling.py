...
simulations=200
dim=5
NumberOfFoundLocalMinima=np.zeros(200)
#%% Rastrigin
for i in range(200):
    NumberOfFoundLocalMinima=random_search_(number_samples, simulations,b1,b2, LocalMinimas, dim, eps)+NumberOfFoundLocalMinima
    
fig=plt.figure()
plt.plot(NumberOfFoundLocalMinima/200)
