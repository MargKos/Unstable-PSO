...
for i in range(simulations):
    NumberOfFoundLocalMinima=random_search_(number_samples, T,b1,b2, dim)+NumberOfFoundLocalMinima

NumberOfFoundLocalMinima=NumberOfFoundLocalMinima/simulations

np.save('./Results/RandomSamplingshortsim143.npy', NumberOfFoundLocalMinima)
'''
#%%
