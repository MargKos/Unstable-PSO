...
axs[0].plot(np.linspace(1, T_PSO_s, T_PSO_s),AverageNumberOfFoundLocalMinimaDivergent[0:T_PSO_s],'o', markersize=7,markevery=100, color='blue', label='Divergent Oscillator')
axs[0].tick_params(axis='x', labelsize=30)
axs[0].tick_params(axis='y', labelsize=30)
axs[0].set_xlabel('time',  fontsize=30)
...
a=plt.hist(AllLocalMinimaDivergentValue,histtype='step', bins=50,color='blue',  label='Divergent Oscillator')
F_O=int(a[0][0])
...
axs[1].text(AllLocalMinimaDivergentValue.min()+0.5, 100, str(F_O), fontsize=26, va='top', ha='left', color='blue')
